...
import sampleImage from "../../public/syphabelnadesimage2.png"
...
export default function Sypha() {

  //const router = useRouter();

  const conteudoTxt = React.useContext(CronologiaContext);
  var title = conteudoTxt.map((c) => c.sypha.title);
  var txt = conteudoTxt.map((c) => c.sypha.content);
